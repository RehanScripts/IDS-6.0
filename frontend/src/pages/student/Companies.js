...
export default function Companies() {
  ...
  return (
    <div className="p-6 md:p-8" data-testid="companies-page">
      <div className="mb-6">
        <h1 className="text-4xl font-semibold text-slate-900 tracking-tight" style={{ fontFamily: 'Outfit' }}>
          Companies
        </h1>
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 bg-indigo-50 rounded-lg flex items-center justify-center">
                <span className="text-lg font-semibold text-indigo-600">{company.company_name?.[0] || 'C'}</span>
              </div>
              <span
            ...
            {company.package && <p className="text-sm font-medium text-indigo-600 mb-4">{company.package}</p>}
